                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="Coin Name" rules="" v-slot="{ errors }">
                                                    <input type="text" class="form-control" v-model="coin.name" placeholder="Bitcoin, Etherium etc"
                                                        required>
                                                    <span class="text-sm text-danger">{{ errors[0] }}</span>
                                                </validation-provider>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="Coin Symbol" rules="" v-slot="{ errors }">
                                                    <input type="text" class="form-control" v-model="coin.symbol" placeholder="BTC, ETH" required>
                                                    <span class="text-sm text-danger">{{ errors[0] }}</span>
                                                </validation-provider>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="Listing Date" rules="" v-slot="{ errors }">
                                                    <input class="form-control" type="date" v-model="coin.launch_date" placeholder="dd/mm/yyyy" required>
                                                    <span class="text-sm text-danger">{{ errors[0] }}</span>
                                                </validation-provider>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="Contract Address" rules="" v-slot="{ errors }">
                                                    <input class="form-control" type="text" v-model="coin.contract_address" placeholder="0x0000000000000000000000000000000000000000"
                                                        required>
                                                    <span class="text-sm text-danger">{{ errors[0] }}</span>
                                                </validation-provider>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <validation-provider name="Coin Description" rules="" v-slot="{ errors }">
                                                    <textarea name="" class="form-control" v-model="coin.coin_description" id="" cols="" rows="10" required></textarea>
                                                    <span class="text-sm text-danger">{{ errors[0] }}</span>
                                                </validation-provider>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.website_link" placeholder="https://www.google.com"
                                                    >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.telegram_link" placeholder="https://t.me/telegram"
                                                    >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.chart_link" placeholder="https://www.poocoin.com/tokens/"
                                                    >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.reddit_link" placeholder="https://reddit.com/r/name/"
                                                    >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.twitter_link" placeholder="https://twitter.com/name/"
                                                    >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="url" class="form-control" v-model="coin.discord_link" placeholder="https://discord.gg/name/"
                                                    >
                                            </div>
                                        </div>
                                    </div>
